...
import s from './DgTgDashboardComponent.module.css'
import Select from 'react-select'
import { Cards, ShoeSideWin, CardImages } from './DgTgData.js'
...
const DgTgDashboardComponent = (props) => {
                    ...
                    <table className={`table-${theme} fontText  table-sm w-100 `}>
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className={`text-end`}>
                            <span
                              className={`rounded-1 ${currentShoeData[index]?.winner == 'D' ? 'bg-primary' : currentShoeData[index]?.winner == 'T' ? 'bg-danger' : 'bg-success'} d-flex justify-content-center   px-2 text-light border-0 bg-gradient px-1 shadow-xs border border-secondary border-opacity-25`}
                            >
                              {currentShoeData[index]?.winner == 'D'
                                ? 'Dragon'
                                : currentShoeData[index]?.winner == 'T'
                                  ? 'Tiger'
                                  : 'Tie'}
                            </span>
                          </td>
...
export default DgTgDashboardComponent
